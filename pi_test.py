...
# Statistics
percent_pos = results.count("+")/len(results)
percent_neu = results.count("0")/len(results)
percent_neg = results.count("-")/len(results)


print(f'Percent positively trending: {percent_pos:2.2%}')
print(f'Percent neutrally trending: {percent_neu:2.2%}')
print(f'Percent negatively trending: {percent_neg:2.2%}')